...
if __name__ == "__main__":
    ...
    vertical_edges = utilities.zero_out_edges(utilities.minimum_filter_2d((1 - img_gray), (21, 1, 1)))
    horizontal_edges = utilities.zero_out_edges(utilities.minimum_filter_2d((1 - img_gray), (1, 21, 1)))
    if args.draw_images:
